...
&#x20; "supported\_locales": \["ar", "en"],

&#x20; "active\_locales": \["ar", "en"],
...
\_\_('common.actions.save');

\_\_('fields.product.title');

\_\_('messages.product.created');

\_\_('pages.products.index.title');

\_\_('status.order.pending');
...
\- `lang\_path()` resolves to root `lang/`.
